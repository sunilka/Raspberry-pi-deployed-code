...
color_thief = ColorThief('/home/pi/Desktop/final_year_project/color/img.jpg')
...
print ('Nearest color name to input RGB ' \
    ...
    +', '+ ColorDiff \
    +'.')
f = open('/home/pi/Desktop/final_year_project/color/color_text.txt',"w")
f.write("Dominant color in the image is : \n")
f.write(ColorName)
f.close()
